...
Factory.prototype = {
    ...
    register: function (constructor) {
        ...
        if (!type) { throw new Error('Could not views ' + this.kind + ' constructor [no TYPE property]: ' + util.inspect(constructor)); }
        ...
        fs.readdirSync(dir).forEach(function (file) {
            if (file !== 'index.js' && file.indexOf('.js') === file.length - 3) {
                try {
                    ...
                    throw new Error('Could not views ' + that.kind + ' from file ' + file);
                }
            }
        });
    },
